...
describe('Player Utilities', () => {
  ...
  describe('getPlayersWithCardInDiscard', () => {
    ...
    it('should return empty array when no matches', () => {
      const withPrincess = getPlayersWithCardInDiscard(
        players,
        'princess',
        false,
      );
  ...
  describe('formatPlayerNames', () => {
    ...
    it('should use Oxford comma for three+ names', () => {
      expect(formatPlayerNames(['Alice', 'Bob', 'Carol'])).toBe(
        'Alice, Bob, and Carol',
      );
    });

    it('should handle four names', () => {
      expect(formatPlayerNames(['Alice', 'Bob', 'Carol', 'Dave'])).toBe(
